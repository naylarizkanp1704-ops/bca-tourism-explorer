    ...
    if (this.state.hasError) {
      return (
        <div className="w-full h-screen flex flex-col items-center justify-center bg-bca-soft px-6 text-center">
          ...
          <h1 className="text-xl font-bold text-bca-ink">Something unexpected happened</h1>
          <p className="text-sm text-bca-sub mt-2 max-w-md">
            {this.state.message || "An unexpected error occurred while rendering the application."}
          </p>
          <button
